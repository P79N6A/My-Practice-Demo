...
// graph.dfs()
// var o = graph.DFS()
// console.log('d', o.discovery)
// console.log('f', o.finished)
// console.log('p', o.predecessors)
...
console.log('d', result.discovery)
console.log('f', result.finished)
// console.log('p', result.predecessors)